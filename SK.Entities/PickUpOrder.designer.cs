...
namespace SK.Entities
{
	...
	public partial class PickUpOrderDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertPickUpOrder(PickUpOrder instance);
    partial void UpdatePickUpOrder(PickUpOrder instance);
    partial void DeletePickUpOrder(PickUpOrder instance);
    #endregion
		
		public PickUpOrderDataContext() : 
				base(global::SK.Entities.Properties.Settings.Default.JGDConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public PickUpOrderDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public PickUpOrderDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public PickUpOrderDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public PickUpOrderDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public System.Data.Linq.Table<PickUpOrder> PickUpOrder
		{
			get
			{
				return this.GetTable<PickUpOrder>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.PickUpOrder")]
	public partial class PickUpOrder : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.DateTime _PickUpAt;
    ...
    partial void OnPickUpAtChanging(System.DateTime value);
    partial void OnPickUpAtChanged();
    ...
    partial void OnTime2Changed();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PickUpAt", DbType="Date NOT NULL")]
		public System.DateTime PickUpAt
		{
			get
			{
				return this._PickUpAt;
			}
			set
			{
				if ((this._PickUpAt != value))
				{
					this.OnPickUpAtChanging(value);
					this.SendPropertyChanging();
					this._PickUpAt = value;
					this.SendPropertyChanged("PickUpAt");
					this.OnPickUpAtChanged();
				}
			}
		}
